  ...
  return (
    <div className="max-w-sm mx-auto bg-white p-6 rounded-lg border">
      ...
      <form onSubmit={submit} className="space-y-3">
        ...
        <input className="w-full border rounded px-3 py-2" type="password" placeholder="密码" value={password} onChange={(e) => setPassword(e.target.value)} />
        {err && <p className="text-red-600 text-sm">{err}</p>}
        <button className="w-full bg-indigo-600 text-white rounded py-2">登录</button>
      </form>
